...
export const testNames = {
  ...
  smartPrepTempTask: `SmartPrep TempTask ${TEST_RUN_ID}`,
  smartPrepTempCheckList: `SmartPrep TempChecklist ${TEST_RUN_ID}`,
  smartPrepLockedCheckList: `SmartPrep LockedChecklist ${TEST_RUN_ID}`,
  smartPrepPastTimeCheckList: `SmartPrep PastTimeChecklist ${TEST_RUN_ID}`,
